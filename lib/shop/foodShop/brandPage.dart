...
class brandPage extends StatefulWidget {
  final String userId, brand;
  brandPage({required this.userId, required this.brand});
...
class _brandPageState extends State<brandPage> {
  ...
  List<String> dogHeaderList = ['assets/orijen.jpg'];
  List<String> catHeaderList = ['assets/orijen.jpg'];
  ...
  getData()async{
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      setState(() {
        filterList = dataList.where((i) => i.brand == widget.brand).toList();
      });
    });
  }
